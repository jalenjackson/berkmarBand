    ...
    <AbsoluteWrapper>
      <Wrapper>
        <h1> Berkmar Band Boosters Accomplishments</h1>
          ...
          <img src={ require('../../../images/BandAccomplishments/constitution.webp') } />
          <p>The Berkmar Band Boosters updated the Bylaws and Constitution of the Organization</p>
        </Card>
      </Wrapper>
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/gwyin.webp') } />
          Gywinn Lewis
      ...
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/phi.webp') } />
          Phi Quach
      ...
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/martinique.webp') } />
          Martinique Campbell
      ...
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/josh.webp') } />
          Josh Hills
          <p>
      ...
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/uniforms.webp') } />
          <p>Berkmar Band Boosters Cleaned and Organized Marching Band And Concert Band Uniforms </p>
        </Card>
      </Wrapper>
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/students.webp') } />
      ...
      <Wrapper>
        <Card style={ CardOverwrite }>
          <img src={ require('../../../images/BandAccomplishments/alumni.webp') } />
